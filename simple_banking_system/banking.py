...
class Bank(object):
    def __init__(self, bank_iin: int, database: sqlite3.Connection):
    ...
    def create_account(self) -> ('BankAccount', str):
    ...
    def get_account(self, card_number, pin) -> Optional['BankAccount']:
        try:
    ...
    @staticmethod
    def luhn_card_verification(destination_card):
        card_number = destination_card[:15]
        card_number = [int(dig)
                       for dig in card_number]
        card_number = [dig if ind % 2 else dig * 2
                       for ind, dig in enumerate(card_number)]
    ...
    def is_card_exists(self, destination_card):
        try:
    ...
    def transfer_funds(self, account, destination_card, amount):
...
class ConsoleUI(object):
    ...
    @staticmethod
    def message_show_new_card(card_number, pin) -> None:
    ...
    @staticmethod
    def message_show_balance(balance) -> None:
        print(f"\nBalance: {balance}")
